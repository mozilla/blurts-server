...
settings-edit-profile-info-form-input-error-duplicate-first-name = Duplicate first name
settings-edit-profile-info-form-input-error-duplicate-middle-name = Duplicate middle name
