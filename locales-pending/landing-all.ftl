...
landing-premium-data-breach-info-qn = What information gets exposed in data breaches?
landing-premium-data-breach-info-ans = Not all breaches expose all the same info. It just depends on what hackers can access. Many data breaches expose email addresses and passwords. Others expose more sensitive information such as credit card numbers, pin numbers, and social security numbers.
