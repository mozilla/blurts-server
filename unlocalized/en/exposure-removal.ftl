...
exposure-landing-result-footer-attribution = Breach data provided by <hibp-link>Have I Been Pwned</hibp-link>
...
exposure-landing-result-some-footer-cta-label = Sign up for alerts
...
exposure-landing-result-none-footer-cta-label = Sign in to resolve breaches
