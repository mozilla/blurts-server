...
const REMOVAL_CONSTANTS = {
  REMOVAL_ADMINS_HASHED: null, //the admin list that gets assigned in server.js on server startup
  REMOVAL_PARTICIPANTS_HASHED: null, //this is the pilot participant list and gets assigned in server.js on server startup
