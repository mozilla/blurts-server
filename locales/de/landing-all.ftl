...
landing-all-quote = <data_breaches>Datenlecks</data_breaches> passieren alle 11 Minuten und legen Ihre persönlichen Daten offen – aber keine Sorge, wir können helfen.

# Non-US FAQ

landing-all-faq-title = Häufig gestellte Fragen
# FAQ is an acronym for Frequently Asked Questions
landing-all-faq-see-all = Alle häufig gestellten Fragen anzeigen
...
landing-all-social-proof-title =
    { $num_users ->
        [one] { $num_users } Million Menschen weltweit vertrauen uns
       *[other] { $num_users } Millionen Menschen weltweit vertrauen uns
    }
# Variables
# $num_countries is the number of countries available.
landing-all-social-proof-description =
    { $num_countries ->
        [one] Seit 2018 helfen wir Menschen in { $num_countries } Ländern, ihre Daten zu schützen, wenn sie offengelegt werden.
       *[other] Seit 2018 helfen wir Menschen in { $num_countries } Ländern, ihre Daten zu schützen, wenn sie offengelegt werden.
    }
landing-all-social-proof-press = Bekannt aus

# Here's How We Help

landing-all-help-protect-you = So schützen wir Sie
landing-all-help-protect-you-description = Wir glauben an Ihr Recht auf Privatsphäre, daher ist der Schutz von Datenlecks immer kostenlos.
landing-all-help-protect-you-feature-one = Wir suchen in allen bekannten Datenlecks für Sie
