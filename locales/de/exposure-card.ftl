...
chevron-alt = Details zur Aufnahme
...
exposure-card-family-members = Familienmitglieder
exposure-card-email = E-Mail-Adresse
exposure-card-phone-number = Telefonnummer
exposure-card-address = Adresse
exposure-card-credit-card = Kreditkarte
exposure-card-password = Passwort
exposure-card-ip-address = IP-Adresse
exposure-card-other = Sonstiges
# Variables:
