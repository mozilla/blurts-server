...
fix-flow-celebration-high-risk-description-next-security-recommendations = A continuación, te brindaremos recomendaciones de seguridad personalizadas basadas en qué datos tuyos han estado expuestos.
...
fix-flow-celebration-leaked-passwords-description-next-security-recommendations = A continuación, te brindaremos recomendaciones de seguridad personalizadas basadas en qué datos tuyos han estado expuestos.
...
high-risk-breach-subheading = Esto requiere acceso a información sensible tuya, por lo que deberás solucionarlo manualmente.
# Variables
...
high-risk-breach-credit-card-description = Cualquiera que lo obtenga puede realizar compras no autorizadas de las que podrías ser responsable. Actúa ahora para evitar daños financieros.
...
high-risk-breach-social-security-description = Los estafadores pueden abrir nuevos préstamos o tarjetas de crédito con tu número de seguro social. Actúa rápido para evitar daños financieros.
...
security-recommendation-phone-summary =
    { $num_breaches ->
        [one] Tu número de teléfono quedó expuesto en { $num_breaches } filtración de datos:
       *[other] Tu número de teléfono quedó expuesto en { $num_breaches } filtraciones de datos:
    }
security-recommendation-phone-description = Lamentablemente no puedes retirarlas. Pero hay medidas que puede tomar para asegurarte de mantenerte a salvo.
security-recommendation-phone-step-one = Bloquea números spam para evitar más llamadas no deseadas
security-recommendation-phone-step-two = No haga clic en enlaces en mensajes de texto de remitentes desconocidos; Si parece ser de una fuente confiable, llama directamente para confirmar.
...
security-recommendation-email-description = Desafortunadamente no puedes arreglar esto. Pero hay medidas que puedes tomar para protegerte.
security-recommendation-email-step-one = No haga clic en enlaces en correos de remitentes desconocidos; Si parece ser de una fuente confiable, llama directamente para confirmar.
...
leaked-security-questions-step-two = Actualízalas en cualquier otro sitio donde hayas reutilizado las mismas preguntas de seguridad. Asegúrate de utilizar diferentes preguntas de seguridad para cada cuenta.
