...
protect-account-prevent-hackers = Evita que los piratas informáticos ingresen a tus cuentas con contraseñas filtradas.
prevent-fraud = Prevén el fraude y los delitos cibernéticos
prevent-fraud-keep-info = Mantén tu información alejada de los piratas informáticos que quieren hacerse pasar ti y cometer delitos.
...
how-it-works = Mira cómo funciona:
