...
identifying-breaches = 找出並處理資料外洩事件，是保護您的線上隱私的重要一步。
...
protect-accounts-clear-steps = 對於牽涉到您的所有資料外洩事件，我們將提供您明確的處理步驟。
alerts-for-breaches = 訂閱資料外洩事件警示
alerts-for-breaches-monitor-new = 我們將持續監控新的資料外洩事件，並在發現您遭受影響時通知。
