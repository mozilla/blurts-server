...
landing-all-help-protect-you = 以下是我們能夠協助保護您的方式
landing-all-help-protect-you-description = 我們認為您的隱私權相當重要，所以資料外洩事件的監控功能永久保持免費。
landing-all-help-protect-you-feature-one = 我們會在已知的資料外洩事件中，尋找是否有您的資料出現
