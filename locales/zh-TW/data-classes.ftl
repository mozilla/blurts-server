...
partial-government-issued-ids = 部分由政府簽發的證件資料
...
shipment-tracking-numbers = 物流追蹤編號
smoking-habits = 抽菸習慣
sms-messages = 簡訊內容
...
vehicle-registration-plates = 車牌登記
vip-statuses = VIP 狀態
warranty-claims = 保固申請
