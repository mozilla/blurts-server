...
what-is-data-agg-blurb = 資料收集器或資料中間商會從公開紀錄或從其他公司購買的資料等來源收集資訊。他們編纂這些資訊來建立詳細的消費者檔案，再賣給企業用做行銷目的。駭客可使用此資料進行檢測、偽裝或進行其他詐騙。資料收集器常常會在人們未註冊的情況下就收集個人資料，所以您未必會知道這些公司。
