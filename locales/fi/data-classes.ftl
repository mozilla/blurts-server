...
customer-service-comments = Asiakaspalvelun kommentit
...
forum-posts = Keskustelualueen viestit
genders = Sukupuolet
...
iq-levels = Älykkyysosamäärätasot
job-applications = Työhakemukset
job-titles = Työnimikkeet
language-preferences = Kieliasetukset
...
partial-government-issued-ids = Osittain viranomaisen myöntämät henkilöllisyystodistukset
...
shipment-tracking-numbers = Lähetyksen seurantanumerot
...
vehicle-registration-plates = Ajoneuvon rekisterikilvet
vip-statuses = VIP-tilat
