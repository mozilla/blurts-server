...
exposure-landing-hero-lead = Pysy turvassa { -brand-firefox }in tekijöiden tietosuojatyökaluilla, jotka suojaavat sinua hakkereilta ja yrityksiltä, jotka julkaisevat ja myyvät henkilökohtaisia tietojasi. Ilmoitamme sinulle tunnetuista tietovuodoista, etsimme ja poistamme paljastuneet tietosi ja seuraamme jatkuvasti uusia tietovuotoja.
...
exposure-landing-result-overflow-hero-lead = Kirjaudu sisään saadaksesi selkeät ohjeet tietovuotojen selvittämiseksi, nähdäksesi kaikki tietovuodot ja saadaksesi jatkuvan seurannan uusien tunnettujen tietovuotojen varalta.
...
exposure-landing-result-some-hero-lead = Kirjaudu sisään saadaksesi selkeät ohjeet tietovuotojen selvittämiseksi, nähdäksesi kaikki tietovuodot ja saadaksesi jatkuvan seurannan uusien tunnettujen tietovuotojen varalta.
...
exposure-landing-result-none-hero-lead = Hyviä uutisia! Tunnettuja tietovuotoja ei löytynyt. Pysy turvassa tilaamalla ilmoitukset uusista tietovuodoista. Seuraamme tätä sähköpostiosoitetta ja ilmoitamme sinulle, jos se ilmenee uudessa tietovuodossa.
