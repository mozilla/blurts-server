...
modal-active-number-of-exposures-title = เกี่ยวกับจำนวนการเปิดเผยที่ตรวจพบ
# Variables:
...
modal-active-number-of-exposures-part-three-all = หลังจากการเปิดเผยถูกแก้ไขแล้ว พวกมันจะถูกเพิ่มเข้าไปในจำนวนรวมของการเปิดเผยที่ถูกแก้ไขแล้วบนหน้าแก้ไขแล้ว
modal-fixed-number-of-exposures-title = เกี่ยวกับจำนวนการเปิดเผยที่ถูกแก้ไขแล้ว
modal-fixed-number-of-exposures-all = แผนภูมินี้แสดงจำนวนของการรั่วไหลของข้อมูลที่ได้รับการแก้ไขสำหรับที่อยู่อีเมลทั้งหมดที่คุณเฝ้าดูอยู่ เมื่อการเปิดเผยถูกทำเครื่องหมายว่าแก้ไขแล้วพวกมันจะถูกนับรวมที่นี่
modal-cta-ok = ตกลง
