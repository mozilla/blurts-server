...
customer-service-comments = ความคิดเห็นด้านการบริการลูกค้า
...
forum-posts = โพสต์ในกระดานสนทนา
genders = เพศ
...
iq-levels = ระดับไอคิว
job-applications = การสมัครงาน
job-titles = ตำแหน่งงาน
language-preferences = ค่าปรับแต่งภาษา
...
partial-government-issued-ids = บัตรประชาชนที่ออกให้โดยรัฐบาลบางส่วน
...
profile-statistics = สถิติโปรไฟล์
...
shipment-tracking-numbers = หมายเลขติดตามการจัดส่ง
...
vehicle-registration-plates = ป้ายทะเบียนรถ
vip-statuses = สถานะวีไอพี
warranty-claims = การเคลมการรับประกัน
