...
latest-breach = การละเมิดที่เพิ่มล่าสุด
# Link title
...
monitor-your-online-accounts = ลงทะเบียนเพื่อตรวจสอบการละเมิดด้วย { -brand-fxa }
...
how-fxm-2-headline = ลงทะเบียนเพื่อตรวจสอบการละเมิด
...
# email address.
breach-summary = ข้อมูลสรุปการละเมิด
show-breaches-for-this-email = แสดงการละเมิดทั้งหมดสำหรับอีเมลนี้
link-change-primary = เปลี่ยนแปลงที่อยู่อีเมลหลัก
remove-fxm = เอา { -product-name } ออก
# Button title
manage-email-addresses = จัดการที่อยู่อีเมล
# Link title
latest-breach-link = ดูว่าคุณอยู่ในการละเมิดนี้หรือไม่
welcome-back = ยินดีต้อนรับกลับมา { $userName }!
welcome-user = ยินดีต้อนรับ { $userName }!
new-breaches-found =
    { $breachCount ->
       *[other] พบ { $breachCount } การละเมิดใหม่
    }
all-breaches-headline = การละเมิดทั้งหมดใน { -product-name }
...
# Button
see-additional-breaches = ดูการละเมิดเพิ่มเติม
...
alert-about-new-breaches = เตือนฉันเกี่ยวกับการละเมิดใหม่
see-if-youve-been-part = ดูว่าคุณเป็นส่วนหนึ่งของการละเมิดข้อมูลออนไลน์หรือไม่
get-ongoing-breach-monitoring = รับการตรวจสอบการละเมิดอย่างต่อเนื่องสำหรับหลายที่อยู่อีเมล
...
menu = เมนู
to-affected-email = ส่งการเตือนการละเมิดไปยังที่อยู่อีเมลที่ได้รับผลกระทบ
...
# alerts for all of their monitored email addresses to a single 
# email address.
breach-alert-notifications = การแจ้งเตือนการละเมิด
# This string is a label for the calendar date a breach is added to the database
# and is followed by that date. 
breach-added-label = วันที่เพิ่มการละเมิด:
