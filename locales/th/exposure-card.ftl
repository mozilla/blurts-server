...
exposure-card-family-members = สมาชิกในครอบครัว
exposure-card-email = อีเมล
exposure-card-phone-number = หมายเลขโทรศัพท์
exposure-card-address = ที่อยู่
exposure-card-credit-card = บัตรเครดิต
exposure-card-password = รหัสผ่าน
exposure-card-ip-address = ที่อยู่ IP
exposure-card-other = อื่นๆ
# Variables:
# $data_breach_company is the company associated with the data breach.
# $data_breach_date is the date of the data breach.
exposure-card-description-data-breach-action-needed = ข้อมูลของคุณถูกเปิดเผยใน<data_breach_link>การละเมิดข้อมูลของ { $data_breach_company } เมื่อ { $data_breach_date }</data_breach_link> เราจะแนะนำขั้นตอนต่างๆ ให้คุณเพื่อแก้ไขปัญหานี้
...
exposure-card-manual-resolution-praise = <b>เยี่ยมเลย!</b> คุณได้แก้ไขปัญหาการเปิดเผยนี้แล้ว
