...
exposure-card-description-data-breach-part-one = Vos informations figurent dans la <data_breach_link>fuite de données { $data_breach_company } du { $data_breach_date }.</data_breach_link>
