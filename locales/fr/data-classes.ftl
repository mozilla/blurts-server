...
customer-service-comments = commentaires du service client
...
partial-government-issued-ids = cartes d’identité partielles
...
shipment-tracking-numbers = numéros de suivi des envois
...
tattoo-status = état du tatouage
...
vehicle-registration-plates = plaques d’immatriculation des véhicules
vip-statuses = statuts VIP
