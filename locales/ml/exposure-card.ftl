...
exposure-card-family-members = ചാൎച്ചക്കാർ
exposure-card-email = ഇതപാൽ
exposure-card-phone-number = ഫോൺ അക്കം
exposure-card-address = വിലാസം
exposure-card-password = രഹസ്യവാക്ക്
exposure-card-ip-address = ഐ.പി വിലാസം
