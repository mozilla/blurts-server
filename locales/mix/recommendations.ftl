...
# Link title
rec-ssn-cta = Kaka tutu kuenta ku
rec-ssn =
...
# Link title
rec-pw-2-cta-fx = Kunche'e nixi nikitsau nu { -brand-name }
rec-pw-2 =
...
# Recommendation subhead
rec-pw-3-subhead = Chika va'a tu'un se'e takua ku kuncheuña ntyi niku
# Link title
rec-pw-3-cta = Tsiniñu'u { -brand-lockwise }
rec-pw-3-fx =
...
rec-pw-3-non-fx = Kuachu'un { -brand-lockwise } takua ko'o va'a tu'un seu cha ku kuncheuña nu kaa ndusu a tablet.
# Recommendation subhead
rec-pw-4-subhead = Establecer verificación en dos pasos
# Link title
rec-pw-4-cta = Kunche'e sitio 2FA
