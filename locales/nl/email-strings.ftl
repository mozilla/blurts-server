...
your-full-report = Hier is uw volledige { -product-name }-rapport, met alle bekende datalekken waarin dit e-mailadres voorkomt.
report-no-breaches =
    Uw e-mailadres komt niet voor in onze database met bekende lekken. 
    Maar lekken kunnen altijd optreden. Neem de volgende stappen om uw persoonlijke gegevens online veilig te houden.
...
breach-alert-headline = Uw account is betrokken bij een datalek.
breach-alert-subhead = Een onlangs gemeld datalek bevat uw e-mailadres en de volgende gegevens
report-pwt-blurb =
