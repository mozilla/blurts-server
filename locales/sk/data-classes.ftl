...
ages = vek
ai-prompts = Výzvy pre umelú inteligenciu
...
customer-service-comments = Komentáre k zákazníckemu servisu
...
partial-government-issued-ids = Čiastočné preukazy totožnosti vydané vládou
...
profile-statistics = Štatistiky profilu
purchases = nákupy
...
shipment-tracking-numbers = Sledovacie čísla zásielok
...
vehicle-registration-plates = ŠPZ vozidiel
vip-statuses = Status VIP
warranty-claims = Reklamácie v záruke
