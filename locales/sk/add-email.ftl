...
add-email-verify-the-link = Pomocou odkazu odoslaného na adresu { $email } ju pridajte do služby { -brand-fx-monitor }. Všetky vaše e-mailové adresy môžete spravovať v <{ $settings-href }Nastaveniach</a>.
