...
landing-all-data-breach-definition-ans = In datalek fynt plak wannear’t persoanlike of priveegegevens sûnder tastimming bleatsteld, stellen of kopiearre wurde. Dizze befeiligingsynsidinten kinne it gefolch wêze fan cyberoanfallen op websites, apps of in database wêr’t de persoanlike gegevens fan minsken yn stean. In datalek kin ek troch fersin barre, bygelyks as oanmeldgegevens fan ien troch fersin iepenbier makke wurde.
