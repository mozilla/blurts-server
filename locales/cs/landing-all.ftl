...
landing-all-hero-emailform-submit-sign-up-label = Zaregistrujte se a získejte bezplatný sken
...
landing-all-social-proof-press = Jak se objevilo v

# Here's How We Help

landing-all-help-protect-you = Takto vás pomáháme chránit
landing-all-help-protect-you-description = Věříme ve vaše právo na soukromí, proto je ochrana před narušením dat vždy zdarma.
