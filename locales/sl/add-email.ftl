...
add-email-your-account-includes =
    { $total ->
        [one] Vaš račun vključuje spremljanje e-poštnega naslova { $total }. Dodajte nov e-poštni naslov in preverite, ali je bil vpleten v krajo podatkov.
...
add-email-send-verification-button = Pošlji povezavo za preverjanje
