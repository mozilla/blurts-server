...
exposure-card-family-members = Družinski člani
exposure-card-email = E-pošta
exposure-card-phone-number = Telefonska številka
exposure-card-address = Naslov
exposure-card-credit-card = Kreditna kartica
