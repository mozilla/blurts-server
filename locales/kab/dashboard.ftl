...
dashboard-exposures-filter-date-found = Azemz n tifin
dashboard-exposures-filter-date-found-last-seven-days = 7 n wussan ineggura
...
dashboard-exposures-filter-status-in-progress = Iteddu
