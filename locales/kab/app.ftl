...
oauth-confirmed-title = { -product-name } : Ajerred yedda
...
user-unsubscribe-survey-title = { -product-name } : Aḥedqis n tuffɣa seg ujerred
user-unsubscribed-title = { -product-name } : Tuffɣa seg ujerred tedda
