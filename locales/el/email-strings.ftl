...
# Variables:
#   $email-address (string) - Email address
email-breach-detected-2 = Τα αποτελέσματα αναζήτησης για τον λογαριασμό <b>{ $email-address }</b> σας εντόπισαν ότι το email σας ενδέχεται να έχει εκτεθεί. Προτείνουμε να ενεργήσετε τώρα για την επίλυση αυτής της παραβίασης.
