...
email-breach-alert-all-hero-heading-1 = { $company-name } λεπτομέρειες παραβίασης δεδομένων
# $company-name is the name of the company/site that was breached.
# $breach-date is the date of the breach.
email-breach-alert-all-lead-1 = { -brand-mozilla-monitor } βρήκε τις πληροφορίες σας σε μια παραβίαση δεδομένων { $company-name } στο { $breach-date }. Λαμβάνετε αυτήν την ειδοποίηση επειδή έχετε εγγραφεί στις <link_to_settings>ειδοποιήσεις παραβιάσεων</link_to_settings>.
...
email-breach-alert-next-steps-description = <sign_in_link>Συνδεθείτε</sign_in_link> στον πίνακα ελέγχου των { -brand-mozilla-monitor } σας. Θα σας καθοδηγήσουμε στα απαραίτητα βήματα για την επίλυσή του.
...
email-breach-alert-faq-ans-1 = Έχετε εγγραφεί για ειδοποιήσεις παραβίασης δεδομένων. <link_to_settings>Ενημερώστε τις προτιμήσεις σας</link_to_settings> ανά πάσα στιγμή στις ρυθμίσεις.
...
email-breach-alert-faq-ans-3 = Μια ειδοποίηση που στέλνει το { -brand-mozilla-monitor } όταν εκτίθενται, κλαπούν ή αντιγράφονται προσωπικές πληροφορίες που παρακολουθείτε χωρίς άδεια.
