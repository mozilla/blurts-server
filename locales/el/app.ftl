...
sensitive-sites-copy = Το { -product-name } αποκαλύπτει λογαριασμούς που σχετίζονται με αυτού του τύπου τις παραβιάσεις μόνο αφού επαληθευτεί μια διεύθυνση email. Αυτό σημαίνει ότι εσείς είστε το μόνο άτομο που μπορείτε να δείτε αν παραβιάστηκαν τα στοιχεία σας (εκτός αν κάποιος άλλος έχει πρόσβαση στον λογαριασμό email σας).
