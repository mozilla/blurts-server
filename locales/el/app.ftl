...
avoid-personal-info-blurb = Είναι εύκολο να βρει κανείς γενέθλια, διευθύνσεις και ονόματα συγγενών στο διαδίκτυο. Μην χρησιμοποιείτε αυτές τις λέξεις στους κωδικούς πρόσβασής σας.
...
five-myths-desc = Μάθετε πώς να αποφεύγετε τα συχνά λάθη κωδικών πρόσβασης που διευκολύνουν έναν hacker.
