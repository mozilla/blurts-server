...
exposure-landing-result-overflow-hero-lead = Log ind for at få klare trin til, hvordan du løser disse datalæk, se alle datalæk og få løbende overvågning for nye kendte datalæk.
...
exposure-landing-result-some-hero-lead = Log ind for at få klare trin til, hvordan du løser disse datalæk, se alle datalæk og få løbende overvågning for nye kendte datalæk.
