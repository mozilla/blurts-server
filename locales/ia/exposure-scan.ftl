...
exposure-landing-result-loading = Cargamento, attende…
exposure-landing-result-error = Alco errate eveniva controlante pro violationes. Actualisa le pagina e retenta.
# Variables:
...
exposure-landing-result-hero-heading =
    { $count ->
        [one] Nos trovava <email>{ $email }</email> exponite in <count>1</count> violation de datos.
       *[other] Nos trovava <email>{ $email }</email> exponite in <count>{ $count }</count> violationes de datos.
    }
exposure-landing-result-card-added = Violation addite:
exposure-landing-result-card-data = Datos exponite:
...
exposure-landing-result-some-footer-cta-label = Accede pro resolver violationes
exposure-landing-result-none-hero-lead = Bon novas! Nulle violationes note ha essite trovate. Sta secur per inscriber te a avisos pro nove violationes. Nos continuara a surveliar iste email e te permittera de saper si illo appare in un nove violationes.
exposure-landing-result-none-hero-cta-label = Obtene avisos re nove violationes
exposure-landing-result-none-footer-cta-label = Inscribe te al avisos
