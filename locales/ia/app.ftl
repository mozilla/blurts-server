...
error-must-be-signed-in = Tu debe aperir session in tu { -brand-fxa }.
error-to-finish-verifying = Pro finir de verificar iste email pro { -product-name }, tu debe aperir session con le adresse de e-mail de tu conto primari.
...
share-facebook-blurb = Ha tu contos in linea essite exponite post un violation de datos?
...
cant-stop-hackers = Tu non pote stoppar le hackers, ma tu pote evitar le mal habitudes que rende lor labor facile.
...
ba-next-step-2 = Cessa completemente de usar le contrasigno exponite.
...
ba-next-step-blurb-3 = Usa un gestor de contrasignos pro crear contrasignos forte e unic. Le gestores de contrasignos immagazina con securitate tote tu credentiales de sorta que tu pote acceder a illos sur tote tu apparatos.
...
marking-this-body = <span>Un vice que tu ha prendite le mesuras possibile pro resolver iste violation</span>, tu pote marcar lo como resolvite. Tu potera sempre retrovar le detalios de iste violation a partir de tu pannello de controlo.
...
ecosystem-promo-headline = Protege tu vita in linea con productos que da le prioritate a tu vita private
...
vpn-promo-headline = Ora es tempore pro reinfortiar tu securitate in linea.
...
vpn-banner-step-3 = Activa le VPN e naviga con securitate
