...
mozilla-security-blog = Blog re le securitate de { -brand-Mozilla }
...
fxa-scan-submit = Cercar in { -product-name }
sign-up-to-check = Registra te pro verificar
...
user-fb-not-compromised-blurb =
    { $breachCount ->
       ...
       *[other] Tu non era in le violation { $breachName }, ma nos trovava que ille adresse email in alteros.
    }
