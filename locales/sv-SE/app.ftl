...
sensitive-sites-copy =
    { -product-name } avslöjar bara konton som är kopplade till den här typen
    av intrång efter att en e-postadress har verifierats. Det betyder att du är den enda
    personen som kan se om din information var en del av intrånget (såvida inte
    någon annan har tillgång till ditt e-postkonto).
...
what-is-data-agg-blurb = Datainsamlare, eller datamäklare, samlar in information från offentliga register och andra källor, inklusive data som köpts från företag. De sammanställer denna information för att skapa detaljerade konsumentprofiler, som säljs till företag i marknadsföringssyfte. Hackare kan använda dessa uppgifter för profilering, identitetsstöld eller andra former av bedrägerier. Du kanske inte känner igen vissa av dessa företag eftersom datainsamlare ofta samlar in information om personer utan att de någonsin skapar ett konto eller registrerar sig för en tjänst.
