...
rec-ssn-subhead = Xem lại báo cáo tín dụng của bạn
# Link title
rec-ssn-cta = Yêu cầu báo cáo tín dụng
rec-ssn =
...
# Link title
rec-pw-3-cta = Tải { -brand-lockwise }
rec-pw-3-fx =
    Sử dụng { -brand-lockwise } để truy cập an toàn mật khẩu mà bạn đã lưu trong
    { -brand-name } từ bất cứ đâu — ngay cả bên ngoài trình duyệt.
rec-pw-3-non-fx =
...
# Link title
rec-pw-4-cta = Xem các trang web cung cấp 2FA
rec-pw-4 =
...
rec-gen-4 =
    Cập nhật ứng dụng, trình duyệt và hệ điều hành trên điện thoại thông minh của bạn giúp thiết bị 
    của bạn an toàn hơn. Những cập nhật này sửa lỗi, lỗ hổng phần mềm và vấn đề bảo mật.
