...
exposure-card-family-members = Thành viên gia đình
exposure-card-email = Email
exposure-card-phone-number = Số điện thoại
exposure-card-address = Địa chỉ
exposure-card-credit-card = Thẻ tín dụng
