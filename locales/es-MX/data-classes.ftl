...
ages = Edades
ai-prompts = Instrucciones de IA
...
cryptocurrency-wallet-addresses = Direcciones de carteras de criptomonedas
...
customer-service-comments = Comentarios de atención a clientes
...
display-names = Nombres de usuario
...
forum-posts = Publicaciones en foros
genders = Géneros
...
vehicle-identification-numbers-vins = Números de identificación del vehículo (VINs)
