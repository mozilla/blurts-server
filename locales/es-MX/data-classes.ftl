...
academic-records = Historial académico
...
credit-scores = Puntaje crediticio
...
partial-government-issued-ids = Identificaciones oficiales parciales
...
shipment-tracking-numbers = Números de guía
...
tattoo-status = Estatus del tatuaje
...
vehicle-registration-plates = Placas de circulación
vip-statuses = Estatus VIP
