...
check-for-breaches = Revisar filtraciones
find-out-what-hackers-know = Averigua lo que saben los hackers de ti. Conoce como estar un paso adelante de ellos.
...
# Link title
latest-breach-link = Ver si estuviste en esta filtración
...
ba-next-step-blurb-1 =
    Una contraseña fuerte es aquella que incluye mayúsculas y minúsculas,
...
ba-next-step-blurb-2 =
    Los criminales informáticos podrían encontrar tu contraseña en la web oscura
...
ba-next-step-3 = Obtén ayuda creando mejores contraseñas y manteniéndolas seguras.
ba-next-step-blurb-3 = Usa un administrador de contraseñas para crear fuertes y únicas contraseñas. Los administradores de contraseñas almacenan todos tu inicios de sesión, así puedes acceder a ellos a través de todos tus dispositivos.

faq1 = No reconozco esta compañía o sitio web. ¿Por qué estoy en esta filtración?
faq2 = ¿Por qué tomó tanto tiempo notificarme de esta filtración?
faq3 = ¿Cómo sé que este es un correo auténtico de { -product-name }?
...
# Variables:
#   $userEmail (String) - User email address
signed-in-as = Iniciaste sesión como { $userEmail }
...
vpn-banner-protect-yourself-with-vpn = <em>Protégete</em> con el { -brand-mozilla-vpn }.
...
vpn-banner-step-1 = Suscribirse a { -brand-mozilla-vpn }
...
ad-unit-relay-cta = Conoce más sobre { -brand-relay }
ad-unit-vpn-cta = Conoce más sobre { -brand-mozilla-vpn }
# ad 1 heading
ad-unit-1-how-do-you-keep = ¿Cómo mantienes tu dirección de correo secreta?
# ad 2 heading
ad-unit-2-do-you-worry = ¿Te preocupas por tu seguridad en las redes Wi-Fi públicas?
# ad 3 heading
...
error-page-error-other-copy = Por favor intenta de nuevo o vuelve más tarde
