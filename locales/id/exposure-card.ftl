...
exposure-card-family-members = Anggota keluarga
exposure-card-email = Surel
exposure-card-phone-number = Nomor telepon
exposure-card-address = Alamat
exposure-card-credit-card = Kartu Kredit
...
exposure-card-manual-resolution-praise = <b>Kerja bagus!</b> Anda telah mengatasi keterpaparan ini.
