...
device-usage-tracking-data = Dados de uso de dispositivo
...
health-insurance-information = Informação de plano de saúde
...
partial-credit-card-data = Dados parciais de crédito
