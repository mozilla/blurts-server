...
latitude-and-longitude-pairs = Coordenadas de latitude e longitude
...
profile-statistics = Estatísticas de perfis
purchases = Compras
...
shipment-tracking-numbers = Números de rastreamento de envios
...
tattoo-status = Status de tatuagens
...
vehicle-registration-plates = Placas de identificação de veículos
