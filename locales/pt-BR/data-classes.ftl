...
homepage-urls = URLs de páginas iniciais
...
loan-information = Informações de empréstimos
...
partial-phone-numbers = Números parciais de telefone
...
survey-results = Resultados de pesquisas de opinião
taxation-records = Registros de tributação
telecommunications-carrier = Operadoras de telecomunicação
...
vehicle-identification-numbers-vins = Números de identificação do veículo (VINs)
