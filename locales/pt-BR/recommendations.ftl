...
rec-ssn =
    Você pode receber por lei três relatórios de crédito gratuitos ao ano. 
    Solicitar e revisar não afeta seu crédito. 
    Procure contas, empréstimos ou cartões de crédito que você não reconhece.
# Recommendation subhead
