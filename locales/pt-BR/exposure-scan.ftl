...
exposure-landing-hero-lead = Fique seguro com as ferramentas de privacidade dos produtores do { -brand-firefox }, que protegem você contra hackers e empresas que publicam e vendem suas informações pessoais. Vamos te alertar sobre quaisquer vazamentos de dados conhecidos, encontrar e remover suas informações expostas e monitorar continuamente novos vazamentos.
...
exposure-landing-result-footer-attribution = Dados de vazamentos fornecidos por <hibp-link>{ -brand-HIBP }</hibp-link>
exposure-landing-result-overflow-hero-lead = Entre na sua conta para obter etapas claras sobre como resolver esses vazamentos, consultar todos os vazamentos e obter monitoramento contínuo de quaisquer novos vazamentos conhecidos.
...
exposure-landing-result-some-hero-lead = Entre na sua conta para obter etapas claras sobre como resolver esses vazamentos, consultar todos os vazamentos e obter monitoramento contínuo de quaisquer novos vazamentos conhecidos.
...
exposure-landing-result-none-hero-lead = Boa notícia! Nenhum vazamento conhecido foi encontrado. Permaneça protegido inscrevendo-se para receber alertas sobre novos vazamentos. Continuaremos monitorando este email e informaremos se ele aparecer em um novo vazamento.
