...
email-added-to-subscription = Értesítjük, ha a(z) { $email } megjelenik egy adatsértésben.
...
monitor-promo-body = Kapjon értesítést, ha a személyes adati kikerülnek egy ismert adatsértésben.
