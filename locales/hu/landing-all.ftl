...
landing-all-hero-title = Találja meg, hol kerülnek ki a személyes adatai – és vegye vissza azokat
...
landing-all-quote = <data_breaches>Adatvédelmi incidensek</data_breaches> 11 percenként történnek, és felfedik a személyes adatait – de ne aggódjon, segíthetünk.
...
landing-all-social-proof-title =
    { $num_users ->
        [one] { $num_users } millió ember bízik meg világszerte
       *[other] { $num_users } millió ember bízik meg világszerte
    }
# Variables
...
landing-all-get-started = A kezdéshez olvassa át az e-mail címét
