...
# Link Title
faq-v2-1 = Nem ismerem ezeket a cégeket vagy weboldalakat? Miért szerepelek ebben az adatvédelmi incidensben?
# Link Title
faq-v2-2 = Kell-e valamit tennem, ha ez az adatvédelmi incidens évekkel ezelőtt történt vagy egy régi fiókomat érinti?
# Link Title
...
pre-fxa-tout-1 = Figyeljen a további adatvédelmi incidensekre
pre-fxa-p-1 =
