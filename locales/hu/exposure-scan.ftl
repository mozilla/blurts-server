...
exposure-landing-hero-lead = Maradjon biztonságban a { -brand-firefox } készítőinek adatvédelmi eszközeivel, amelyek megvédik Önt a hackerektől, és a személyes adatait közzétevő és értékesítő cégektől. Figyelmeztetni fogjuk az összes ismert adatsértésről, megtaláljuk és eltávolítjuk a kikerült adatait, és folyamatosan figyeljük az új kikerüléseket.
exposure-landing-hero-email-label = E-mail cím
exposure-landing-hero-email-placeholder = Adja meg az e-mail címét
exposure-landing-hero-cta-label = Adatsértések keresése
exposure-landing-result-loading = Betöltés, kis türelmet…
exposure-landing-result-error = Hiba történt az adatvédelmi incidensek keresése közben. Frissítse az oldalt és próbálja újra.
# Variables:
...
exposure-landing-result-hero-heading =
    { $count ->
        [one] <email>{ $email }</email> felhasználót kikerülve találtuk <count>1</count> adatsértésben.
       *[other] <email>{ $email }</email> kikerülve találtuk <count>{ $count }</count> adatsértésben.
    }
exposure-landing-result-card-added = Adatvédelmi incidens hozzáadva:
exposure-landing-result-card-data = Kitett adatok:
...
exposure-landing-result-overflow-hero-lead = Jelentkezzen be, hogy egyértelmű lépéseket kapjon arról, hogyan oldhatja meg ezeket az adatsértéseket, megtekintheti az összes adatsértést, és kaphat folyamatos ellenőrzést az új ismert adatvédelmi incidensek tekintetében.
...
exposure-landing-result-some-hero-lead = Jelentkezzen be, hogy egyértelmű lépéseket kapjon arról, hogyan oldhatja meg ezeket az adatsértéseket, megtekintheti az összes adatsértést, és kaphat folyamatos ellenőrzést az új ismert adatvédelmi incidensek tekintetében.
...
exposure-landing-result-none-hero-lead = Jó hírek! Nem találhatók ismert adatvédelmi incidensek. Maradjon biztonságban: iratkozzon fel az új adatvédelmi incidensek figyelmeztetéseire. Folyamatosan figyeljük ezt az e-mailt, és értesítjük, ha egy új adatvédelmi incidensben jelenik meg.
