...
settings-tab-notifications-marketing-text = Rendszeres frissítések a { -brand-monitor }ról, a { -brand-mozilla }ról és más biztonsági termékeinkről.
settings-tab-notifications-marketing-link-label = Ugorjon a { -brand-mozilla } e-mail beállításaihoz
