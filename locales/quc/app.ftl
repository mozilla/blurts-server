...
search-all-emails = Che'atzukuj pa ronojel taq akemriqonib'al rech taqoqxa'nib'al we k'o retztaqan chi'l che'ariqa' taq na'b'anem chi rij taq k'axk'olil.
...
unverified-breach = Retztaqan man q'atutal taj
...
confirmation-3-subhead = ¡Xqaj chi jun. Utz chak!
# This string contains nested markup that becomes a link later in the code.
# Please do not modify or remove "<a>" and "</a>".
