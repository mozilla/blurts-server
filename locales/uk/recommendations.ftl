...
# Recommendation subhead
rec-email-subhead = Використовувати ім'я з електронної пошти
...
# Recommendation subhead
rec-ip-subhead = Користуйтеся службою, яка маскує вашу IP-адресу
# Link title
rec-ip-us-cta = Спробуйте { -brand-fpn }
rec-ip-us =
    Ваша адреса інтернет-протоколу (IP-адреса) визначає ваше розташування 
    та постачальника інтернету. Служба { -brand-fpn } 
...
rec-moz-vpn =
    Ваша адреса інтернет-протоколу (IP адреса) може видати ваше розташування й інтернет-провайдера. Служба на кшталт
    { -brand-fpn } приховує вашу IP-адресу та розташування { -brand-name }, а служба на кшталт { -brand-mozilla-vpn } приховує
    вашу IP-адресу та розташування вашого пристрою в цілому.
