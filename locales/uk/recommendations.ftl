...
rec-moz-vpn-update =
    Ваша адреса Інтернет-Протоколу (IP-адреса) може розкрити ваше розташування та постачальника послуг Інтернету. Такий продукт, 
    як { -brand-mozilla-vpn } приховує IP-адресу та розташування вашого пристрою.
