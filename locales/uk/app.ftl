...
wtd-after-website = Що робити після витоку даних веб-сайту:
...
no-pw-to-change = На відміну від витоків даних веб-сайтів, в цьому випадку неможливо змінити пароль.
...
faq1 = Я не впізнаю цю компанію чи веб-сайт. Чому мої дані потрапили до цього витоку?
