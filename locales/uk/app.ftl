...
pwt-summary-4 =
    Такі менеджери паролів, як 1Password, LastPass, Dashlane та Bitwarden генерують надійні, унікальні паролі. 
...
scan-privacy = Ваша е-пошта не зберігатиметься.
scan-submit = Пошук вашої адреси е-пошти
...
signup-modal-blurb = Підпишіться для отримання повного звіту, попереджень про нові загрози, а також поради щодо безпеки від { -product-name-nowrap }.
signup-modal-close = Закрити
get-your-report = Отримайте свій звіт
