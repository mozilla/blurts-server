...
# The `breached-company-link` tags will be replaced with link tags or stripped if no link is available.
breach-checklist-sq-body-text = Na maioria dos casos, recomendamos que atualize as suas perguntas de segurança no site da empresa. Mas <b>o site pode estar offline ou conter conteúdo malicioso</b>, por isso tenha cuidado ao <breached-company-link>visitar o site</breached-company-link>. Para uma proteção adicional, atualize estas questões de segurança em quaisquer contas importantes nas quais as tenha utilizado e crie palavras-passe únicas para todas as contas.
