...
fx-desktop = Navegador { -brand-name } para PC
fx-mobile = Navegador { -brand-name } para dispositivos móveis
...
bento-button-title = Aplicações e serviços do { -brand-name }

# Bento headline
fx-makes-tech = O { -brand-name } é tecnologia que luta pela sua privacidade na Internet.

# A link at the bottom of the Bento menu
made-by-mozilla = Criado por { -brand-Mozilla }
