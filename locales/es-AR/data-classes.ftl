...
loyalty-program-details = Detalles del programa de fidelización
...
none-data-class = Ninguna
occupations = Ocupaciones
# various data classes grouped together
other-data-class = Otras
