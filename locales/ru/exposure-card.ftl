...
exposure-card-family-members = Члены семьи
exposure-card-email = Эл. почта
exposure-card-phone-number = Номер телефона
exposure-card-address = Адрес
exposure-card-credit-card = Банковская карта
