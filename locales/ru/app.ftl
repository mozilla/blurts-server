...
unsub-survey-blurb =
    Ваш адрес электронной почты отписан от { -product-name-nowrap }. Благодарим вас за использование нашего сервиса.
    Уделите нам минутку, что ответить на вопрос о ваших впечатлениях?
