...
facebook-breach-note =
    ...
    но ваш номер телефона всё ещё может быть уязвим. </span> Некоторые учётные записи,
    скомпрометированные в утечке Facebook, включали номера телефонов и другую
    личную информацию, но не адреса электронной почты. Если вы когда-либо регистрировали
    учётную запись Facebook — и даже если вы не используете её сейчас — мы рекомендуем вам
    предпринять эти шаги, чтобы защитить себя
# This string contains nested markup that is later used to style and link the text inside of it.
# Please do not modify or remove "<a>", "</a>", "<span>" and "</span>".
facebook-breach-what-to-do-1-headline = <span>Установите для своей информации значение «Только я» или другой непубличный параметр в <a>своем профиле Facebook</a>.</span>
facebook-breach-what-to-do-1-copy =
    Во время этой утечки хакеры взяли информацию из
    профиля, которая была установлена как «открыта для всех» или «открыта друзьям».
    Эта информация может быть объединена с другими данными, чтобы получить доступ к ещё большему количеству
    вашей личной информации и учётным записям.
facebook-breach-what-to-do-3 = Смотрите все рекомендации на нашей странице об утечке в Facebook
