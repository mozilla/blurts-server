...
rec-pw-1 =
    Сделайте этот пароль уникальным и отличающимся от других, которые вы используете.
    Хорошей стратегией является использование двух или более не связанных между собой
    слов, чтобы создать фразу-пароль.
# Recommendation subhead
...
# Recommendation subhead
rec-pw-4-subhead = Настройте двухэтапную аутентификацию (2FA)
# Link title
rec-pw-4-cta = Посмотреть сайты, которые поддерживают двухэтапную аутентификацию
rec-pw-4 = Многие сайты имеют возможность включения двухэтапной аутентификации для повышения безопасности. Это требует ввода дополнительной информации для входа в ваш аккаунт, например, одноразового кода, получаемого в текстовом сообщении.
# Recommendation subhead
...
# Recommendation subhead
rec-ip-subhead = Используйте сервис, который скрывает ваш IP-адрес
# Link title
rec-ip-us-cta = Попробуйте { -brand-fpn }
# Recommendation subhead
