...
rec-moz-vpn-update =
    Ваш IP-адрес может раскрыть ваше местоположение и вашего
    Интернет-провайдера. Такие сервисы, как { -brand-mozilla-vpn },
    скрывают ваш IP-адрес и местоположение всего вашего устройства.
