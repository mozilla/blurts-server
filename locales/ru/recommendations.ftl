...
rec-ip-us =
    Ваш IP-адрес определяет местоположение вас
    и вашего Интернет-провайдера. Такие сервисы, как { -brand-fpn },
    маскируют ваш IP-адрес, чтобы скрыть ваше местоположение.
rec-ip-non-us =
    Ваш IP-адрес определяет местоположение вас
    и вашего Интернет-провайдера. С помощью виртуальной частной сети (VPN), вы можете скрыть своё местоположение
    и замаскировать свой IP-адрес.
# Recommendation subhead
rec-moz-vpn-cta = Попробуйте { -brand-mozilla-vpn }
rec-moz-vpn =
    Ваш IP-адрес может раскрыть местоположение вас и вашего Интернет-провайдера. Такие сервисы, как
    { -brand-fpn }, скрывают ваш IP-адрес и местоположение для { -brand-name }, а такие сервисы, как { -brand-mozilla-vpn }, скрывают ваш
    IP-адрес и местоположение для всего вашего устройства.
