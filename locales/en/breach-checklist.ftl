...
breach-checklist-pw-header = Go to <a>{$companyLink}</a> to change your password and enable two-factor authentication (2FA). 
...
# NOTE: { $companyLink } is a placeholder for the URL to the password change page of the company where the breach occurred 
breach-checklist-sq-header = Update your security questions on <a>{$companyLink}</a>. 
