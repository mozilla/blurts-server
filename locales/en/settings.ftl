...
settings-unsubscribe-dialog-confirmation = Please note, all of your { -brand-monitor-plus } services will be <a { $faq_href }>permanently deleted</a> after your current billing cycle ends.
