...
exposure-card-family-members = Aelodau o'r teulu
exposure-card-email = E-bost
exposure-card-phone-number = Rhif ffôn
exposure-card-address = Cyfeiriad
exposure-card-credit-card = Cerdyn Credyd
