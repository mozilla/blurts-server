...
error-must-be-signed-in = آپ کو اپنے { -brand-fxa } میں سائن ان ہونا ضروری ہے۔
...
landing-headline = ہیکرز سے محفوظ رہنے کا آپ کا حق یہاں سے شروع ہوتا ہے۔
...
form-signup-error = ایک جائز ایمیل ہونا چاہیے
...
even-for-old = یہاں تک کہ پرانے اکاؤنٹس کے لیے بھی ، اپنے پاس ورڈ کی تازہ کاری کرنا ضروری ہے۔
make-new-pw-unique = نیا پاس ورڈ مختلف اور منفرد بنائیں
strength-of-your-pw = آپ کے پاس ورڈز کی طاقت براہ راست آپ کی آن لائن سلامتی کو متاثر کرتی ہے۔
...
email-sent = اى ميل ارسال کر دی گئى
# Form title
want-to-add = ایک اور ای میل شامل کرنا چاہتے ہیں؟
