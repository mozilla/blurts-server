...
comments = commenti
company-names = nomi di società
credit-card-cvv = CVV di carta di credito
credit-cards = carte di credito
credit-scores = punteggi relativi al credito
credit-status-information = informazioni sullo stato del credito
cryptocurrency-wallet-addresses = indirizzi di portafogli di criptovaluta
...
customer-service-comments = commenti del servizio clienti
...
display-names = nomi visualizzato
...
partial-government-issued-ids = parziali documenti di identificazione rilasciati dallo stato
...
profile-statistics = statistiche del profilo
purchases = acquisti
...
shipment-tracking-numbers = numeri di tracciabilità delle spedizioni
...
socioeconomic-levels = livelli socioeconomici
...
vehicle-registration-plates = targhe di immatricolazione dei veicoli
vip-statuses = stato VIP
warranty-claims = richieste di garanzia
