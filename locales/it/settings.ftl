...
settings-unsubscribe-dialog-title = Siamo spiacenti di vederti andare via. <br /> Puoi dirci perché te ne vai?
...
settings-unsubscribe-dialog-message-placeholder = Cosa poteva andare meglio?
...
settings-unsubscribe-dialog-continue = Continua fino alla cancellazione
settings-unsubscribe-dialog-cancel = Non importa, riportami indietro
