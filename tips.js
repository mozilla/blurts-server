...
const TIPS = {
    getPasswordTips() {
      ...
      {
        "image" : "password-tip-3.svg",
        "alt": "Make strong security questions.",
      ...
      {
        "image" : "password-tip-4.svg",
        "alt": "Use a password manager.",
      ...
      {
        "image" : "password-tip-5.svg",
        "alt": "Use two-factor authentication.",
        "headline": "Use Two-Factor<br>Authentication",
        "summary": "Websites that offer two-factor authentication (also known as 2FA) will commonly register your mobile number or provide you with an access code to install an app.",
      },
      {
        "image" : "password-tip-6.svg",
        "alt": "Sign up for alerts from Firefox Monitor.",
