           ...
           <div>
             <div className="card-container">
               {props.breaches
                 ...
                 .map(breach => <BreachCard key={breach.Domain} breach={breach} logos={props.breachLogos}/>)}
             </div>
           </div>
      ...
      <div className="breach-main">
        <dl>
          <div>
            ...
            <dd>{new Date(props.breach.AddedDate).toLocaleString('fr' /* TODO: getLocale() */, { year: 'numeric', month: 'long', day: 'numeric' })}</dd>
          </div>
          <div>
...
function formatList (list: string[]) {
  ...
  return (new Intl.ListFormat('fr' /* TODO: getLocale() */, { type: 'unit', style: 'short' })).format(list)
}
