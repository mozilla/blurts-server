...
export const Dashboard = () => {
  ...
  return (
    <ShellEl l10n={getL10n()} session={null}>
      ...
      <ExposureCard exposureImg={FamilyTreeImage} exposureName={"Familytree.com"} exposureType={"Info for sale"} exposureDetailsLink={"linkeehere.com"} dateFound={"11/09/2022"} statusPillType={"needAction"} />
    </ShellEl>
  );
}
