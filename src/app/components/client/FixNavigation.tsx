...
import stepDataBrokerProfilesIcon from "../../(proper_react)/(authenticated)/user/(dashboard)/dashboard/fix/images/step-counter-data-broker-profiles.svg";
import stepHighRiskDataBreachesIcon from "../../(proper_react)/(authenticated)/user/(dashboard)/dashboard/fix/images/step-counter-high-risk.svg";
import stepLeakedPasswordsIcon from "../../(proper_react)/(authenticated)/user/(dashboard)/dashboard/fix/images/step-counter-leaked-passwords.svg";
import stepSecurityRecommendationsIcon from "../../(proper_react)/(authenticated)/user/(dashboard)/dashboard/fix/images/step-counter-security-recommendations.svg";
