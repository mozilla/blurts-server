...
describe('utils:breach-resolution', () => {
  ...
  test('breachSummary: resolved breaches', () => {
    ...
    expect(resp.breachedDataTypes.passwords).toEqual(2)
    expect(resp.breachedDataTypes['email-addresses']).toEqual(3)
    expect(resp.breachedDataTypes['ip-addresses']).toEqual(1)
    expect(resp.breachedDataTypes.other).toEqual(1)
  })
})
