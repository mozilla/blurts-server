...
export function convertSnakeToCamelCase(string) {
  const underscore = "_";
...
const getIndexFileContent = (modules) => `/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */

// AUTOGENERATED BY the script generateGleanModulesIndex.
// DO NOT EDIT. DO NOT COMMIT.

${modules.map(module => `import * as ${module} from "./${module}.ts";`).join("\n")}
