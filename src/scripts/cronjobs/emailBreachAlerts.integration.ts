...
jest.mock("../../app/functions/server/refreshStoredScanResults", () => ({
  refreshStoredScanResults: jest.fn(() => Promise.resolve()),
}));
...
jest.mock("../../app/functions/universal/premium", () => ({
  isEligibleForPremium: jest.fn(() => false),
}));

jest.mock("../../app/functions/universal/user", () => ({
