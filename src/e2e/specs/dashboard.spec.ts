...
test.describe.skip(
  `${process.env.E2E_TEST_ENV} - Breaches Dashboard - Headers @smoke`,
  () => {
...
test.describe.skip(
  `${process.env.E2E_TEST_ENV} - Breaches Dashboard - Content @smoke`,
  () => {
    test.beforeEach(async ({ dashboardPage, page }) => {
      await dashboardPage.open();
...
test.describe.skip(
  `${process.env.E2E_TEST_ENV} - Breaches Dashboard - Payment`,
  () => {
    test.beforeEach(async ({ dashboardPage, page }) => {
      await dashboardPage.open();
...
test.describe.skip(
  `${process.env.E2E_TEST_ENV} - Breaches Dashboard - Breaches Scan, Continuous Protection, Data Profile Actions`,
  () => {
...
test.describe.skip(
  `${process.env.E2E_TEST_ENV} - Breaches Dashboard - Overview Card`,
  () => {
    test.beforeEach(async ({ dashboardPage, page }) => {
      await dashboardPage.open();
...
test.describe.skip(
  `${process.env.E2E_TEST_ENV} - Breaches Dashboard - Footer`,
  () => {
    test.beforeEach(async ({ dashboardPage, page }) => {
      await dashboardPage.open();
      try {
...
test.describe.skip(
  `${process.env.E2E_TEST_ENV} - Breaches Dashboard - Navigation @smoke`,
  () => {
    test.beforeEach(async ({ dashboardPage, page }) => {
      await dashboardPage.open();
