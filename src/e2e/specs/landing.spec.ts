  ...
  () => {
    ...
    test('Observe "Find where your private info is exposed and take it back" section', async ({
      ...
      if (await emailInputShouldExist(landingPage)) {
        ...
        await expect(
          landingPage.monitorHeroFormInputSubmitButton,
        ).toBeVisible();
      }
    ...
    test('Observe "We will help you fix your exposures" section', async ({
      ...
      if (await emailInputShouldExist(landingPage)) {
        ...
        await expect(
          landingPage.fixExposuresFormInputSubmitButton,
        ).toBeVisible();
      }
    ...
    test('Observe "What info could be at risk?" section', async ({
      ...
      if (await emailInputShouldExist(landingPage)) {
        await expect(
          landingPage.couldBeAtRiskFormEmailInputField,
        ).toBeVisible();
      }
      await expect(
        landingPage.couldBeAtRiskFormInputSubmitButton,
      ).toBeVisible();
    ...
    test('Observe "Scan your email to get started" section', async ({
      ...
      if (await emailInputShouldExist(landingPage))
        await expect(
          landingPage.getStartedScanFormEmailInputField,
        ).toBeVisible();
